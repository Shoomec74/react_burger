...
export const ORDER_MODAL: "ORDER_MODAL" = "ORDER_MODAL";
export const FEED_MODAL: "FEED_MODAL" = "FEED_MODAL";
export const PROFILE_MODAL: "PROFILE_MODAL" = "PROFILE_MODAL";
...
export const REFRESH_CONSTRUCTOR: "REFRESH_CONSTRUCTOR" = "REFRESH_CONSTRUCTOR";
...
export const GET_USER_INFO_FALED: "GET_USER_INFO_FALED" = "GET_USER_INFO_FALED";
export const UPDATE_USER_TOKEN_REQUEST: "UPDATE_USER_TOKEN_REQUEST" = "UPDATE_USER_TOKEN_REQUEST";
export const UPDATE_USER_TOKEN_SUCCES: "UPDATE_USER_TOKEN_SUCCES" = "UPDATE_USER_TOKEN_SUCCES";
export const UPDATE_USER_TOKEN_FALED: "UPDATE_USER_TOKEN_FALED" = "UPDATE_USER_TOKEN_FALED";
...
export const UPDATE_USER_INFO_FALED: "UPDATE_USER_INFO_FALED" = "UPDATE_USER_INFO_FALED";
...
export const FORGOT_USER_PASSWORD_REQUEST: "FORGOT_USER_PASSWORD_REQUEST" = "FORGOT_USER_PASSWORD_REQUEST";
export const FORGOT_USER_PASSWORD_SUCCESS: "FORGOT_USER_PASSWORD_SUCCESS" = "FORGOT_USER_PASSWORD_SUCCESS";
export const FORGOT_USER_PASSWORD_FALED: "FORGOT_USER_PASSWORD_FALED" = "FORGOT_USER_PASSWORD_FALED";
...
export const RESET_USER_PASSWORD_FALED: "RESET_USER_PASSWORD_FALED" = "RESET_USER_PASSWORD_FALED";
