...
function OrderDetails({orderData}) {
  ...
  return (
    <div className={popup}>
      <h2 className="text text_type_digits-large mt-30 mr-25 ml-25">{orderData.orderNumber}</h2>
      ...
      <p className="text text_type_main-default mr-25 ml-25">{orderData.status.statusText}</p>
